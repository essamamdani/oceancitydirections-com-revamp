...
import { getSubmissionForEdit, updateSubmissionAction } from "../../actions";
...
export default function EditSubmissionPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const subRes = await getSubmissionForEdit(params.id);
                if (!subRes.error && subRes.data) {
                    setFormData(subRes.data.submission_data);
                } else {
                    toast.error(subRes.error || "Failed to load submission");
    ...
    const handlePlaceSelected = (place) => {
        ...
        if (county) county = county.replace(/ County$/i, "").trim();
    ...
    const handleSubmit = async (e) => {
        ...
        setSaving(true);
        try {
            const result = await updateSubmissionAction(params.id, formData);
            if (result.success) {
    ...
    // Synthetic business object for VideoUploadModal (uses submission data)
    const submissionAsBusiness = {
        id: params.id,
        ...
        <>
                        ...
                        <div className="col-lg-9 col-md-12">
                            <div className="bg-white rounded-4 shadow-sm p-4 p-md-5">
                                <div className="mb-4 pb-3" style={{ borderBottom: '1px solid #f0f0f0' }}>
                                    <h2 className="fw-bold mb-1" style={{ fontSize: '1.8rem' }}>Edit Submission</h2>
                                    <p className="text-muted mb-0">Update your business details below</p>
                                </div>
                                ...
                                <div className="row g-4 mb-4">
                                    ...
                                    <div className="col-md-4">
                                        <div className="upload-card h-100">
                                            ...
                                            <div className="upload-zone">
                                                <div className="upload-placeholder" style={{ cursor: 'pointer' }} onClick={() => setVideoModalOpen(true)}>
            ...
            <VideoUploadModal
                ...
                onSuccess={(videoData) => {
                    ...
                    toast.success("Video uploaded! Save submission to attach.");
